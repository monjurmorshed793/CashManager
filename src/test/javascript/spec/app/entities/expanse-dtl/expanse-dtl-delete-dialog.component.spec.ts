...
describe('Component Tests', () => {
  describe('ExpanseDtl Management Delete Component', () => {
    let comp: ExpanseDtlDeleteDialogComponent;
    let fixture: ComponentFixture<ExpanseDtlDeleteDialogComponent>;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        declarations: [ExpanseDtlDeleteDialogComponent],
      })
        .overrideTemplate(ExpanseDtlDeleteDialogComponent, '')
        .compileComponents();
      fixture = TestBed.createComponent(ExpanseDtlDeleteDialogComponent);
