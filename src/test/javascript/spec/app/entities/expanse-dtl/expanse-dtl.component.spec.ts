...
describe('Component Tests', () => {
  describe('ExpanseDtl Management Component', () => {
    let comp: ExpanseDtlComponent;
    let fixture: ComponentFixture<ExpanseDtlComponent>;
    let service: ExpanseDtlService;

    beforeEach(() => {
      TestBed.configureTestingModule({
        imports: [CashManagerTestModule],
        declarations: [ExpanseDtlComponent],
        providers: [
          {
        ...
        .overrideTemplate(ExpanseDtlComponent, '')
        .compileComponents();

      fixture = TestBed.createComponent(ExpanseDtlComponent);
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.expanseDtls && comp.expanseDtls[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
