...
import { ExpanseComponent } from 'app/entities/expanse/expanse.component';
import { ExpanseService } from 'app/entities/expanse/expanse.service';
import { Expanse } from 'app/shared/model/expanse.model';

describe('Component Tests', () => {
  describe('Expanse Management Component', () => {
    let comp: ExpanseComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ExpanseComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.expanses && comp.expanses[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
