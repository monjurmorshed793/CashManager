...
/**
 * Criteria class for the {@link org.cash.manager.domain.Expanse} entity. This class is used
 * in {@link org.cash.manager.web.rest.ExpanseResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /expanses?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class ExpanseCriteria implements Serializable, Criteria {
    /**
    ...
    public ExpanseCriteria(ExpanseCriteria other) {
    ...
    @Override
    public ExpanseCriteria copy() {
        return new ExpanseCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final ExpanseCriteria that = (ExpanseCriteria) o;
        return
