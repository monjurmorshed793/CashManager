...
/**
 * Criteria class for the {@link org.cash.manager.domain.ExpanseDtl} entity. This class is used
 * in {@link org.cash.manager.web.rest.ExpanseDtlResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /expanse-dtls?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class ExpanseDtlCriteria implements Serializable, Criteria {
    ...
    public ExpanseDtlCriteria(ExpanseDtlCriteria other) {
    ...
    @Override
    public ExpanseDtlCriteria copy() {
        return new ExpanseDtlCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final ExpanseDtlCriteria that = (ExpanseDtlCriteria) o;
        return
