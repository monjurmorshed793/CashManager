...
public class ExpanseDtlResource {
    ...
    public ResponseEntity<ExpanseDtlDTO> createExpanseDtl(@Valid @RequestBody ExpanseDtlDTO expanseDtlDTO) throws URISyntaxException {
    ...
    public ResponseEntity<ExpanseDtlDTO> updateExpanseDtl(@Valid @RequestBody ExpanseDtlDTO expanseDtlDTO) throws URISyntaxException {
